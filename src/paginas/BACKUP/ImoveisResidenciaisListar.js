                        ...
                        <div className="server_card">
                            ...
                            <div className="server_card-body">
                                <div className="divserver_btn">
                                    ...
                                    <Link to="/imovel_residencial/adicionar" className="server_btn server_btn-success_add">Adicionar (+)</Link>
                                ...
                                <table className="server_table-bordered">
                                    <thead className="bg-dark server_text-white">
                                        <tr className="server_tr">
                                            ...
                                            <td className="server_td"><b className="server_b">Área</b></td>
                                            <td className="server_td"><b className="server_b">Quartos</b></td>
